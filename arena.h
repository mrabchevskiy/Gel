...
#define ARENA_H_INCLUDED
 ...
 2020.12.03 Initial version

 2020.12.29 Modification: request for empty span allowed and returns dafault span without actual allocation

 2021.01.02 Small improvements suggected by compliler
...
//    assert( length > 0 );                                                                                    // [-] 2020.12.29
      if( length == 0 ) return std::span< T >{};                                                               // [+] 2020.12.29
                                                                                                                                /*
      Allocate T[ length ]:
                                                                                                                                */
